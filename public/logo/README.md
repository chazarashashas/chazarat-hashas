...
Six tiles for the six sedarim on two even rows, over a shallow curved base: six sedarim at a
glance, a ש if you look twice. The first tile — top **right**, Zeraim, because the mark reads
...
| Curve | spans the full 3.44, ends one gap below the tiles, sags a quarter tile |
...
| Air | 0.52em of the name from the trough to the letter tops |
...
- Deepen the curve. A quarter tile reads as a base; more reads as a smile.
- Set Hebrew type on the curve, or stretch, tilt or crop any letter.
